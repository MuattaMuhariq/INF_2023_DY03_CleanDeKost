<x-app-layout>
  <div class="relative overflow-hidden bg-[url('/Images/pexels-huseyn-kamaladdin-667838.jpg')] bg-center bg-cover">
      <div class="flex flex-col justify-center min-h-screen backdrop-blur-sm">
          ...
          <div
              class="overflow-hidden bg-white sm:rounded-xl relative w-5/6 ml-30 mb-60 drop-shadow-2xl container px-4 mx-auto">
                      ...
                      <tr>
                          @foreach($resevasi as $data)
                              ...
                              <td class="flex justify-center">
                                                  <a href="/RincianPembayaranUser">
                                                      <button
                                                          class="bg-blue-500 hover:bg-blue-700 text-white
                                                          font-bold py-2 px-4 mt-10 mb-10 rounded focus:outline-none
