    ...
    <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div class="flex flex-col lg:flex-row justify-between gap-8">
            <div class="w-full lg:w-5/12 flex flex-col justify-center">
                <h1 class="text-3xl lg:text-4xl font-bold leading-9 text-black dark:text-black pb-4">About Us</h1>
                <p class="font-normal text-base leading-6 text-black dark:text-black">
                    website Clean de kost ini merupakan website jasa
                    sampah/barang bekas dirumah atau di kos melalui
                    pemesanan online.Website ini juga menyediakan penukaran barang
                    bekas yang memiliki nilai harga jual yang kami beli dan kami tukarkan ke pemotongan harga jasa kami
                </p>
            </div>
        ...
        <div class="flex lg:flex-row flex-col justify-between gap-8 pt-12">
            <div class="w-full lg:w-5/12 flex flex-col justify-center">
                ...
                <p class="font-normal text-base leading-6 text-black dark:text-black">
                    Kelompok 3 ini kami beri nama Clean de kost Dimana pada kelompok ini terdiri dari beberapa anggota
                    dan diketuai oleh Muatta Muhariq
                    Projek ini kami beri nama clean de kost karena berdasarkan dari jasa pembersihan kos yang dimana Ide
                    ini muncul berdasarkan tema yang diberi oleh dosen pengampu dengan tema sampah.
                </p>
            </div>
                ...
                <div class="flex flex-col gap-4 items-center justify-center">
                    <div class="flex flex-row gap-10">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center border-4 border-black w-fit">
                            <img class="md:block hidden w-[150px] h-[200px]" src="Images/rendika.jpeg"
                                alt="Rendika featured Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Rendika</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center border-4 border-black w-fit">
                            <img class="md:block hidden w-[150px] h-[200px]" src="Images/tasya.jpeg"
                                alt="tasya featured Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Tasya</p>
                        </div>
                    </div>
                    <div class="flex flex-row gap-10">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center border-4 border-black w-fit">
                            <img class="md:block hidden w-[150px] h-[200px]" src="Images/poto.jpeg"
                                alt="Rendika featured image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Muatta</p>
                        </div>
                    </div>
                    <div class="flex flex-row gap-10">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center border-4 border-black w-fit">
                            <img class="md:block hidden w-[150px] h-[200px]" src="Images/hadija.jpg"
                                alt="Hadija featured Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Hadija</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center border-4 border-black w-fit">
                            <img class="md:block hidden w-[150px] h-[200px]" src="Images/Rayyan.JPG"
                                alt="Rayyan featured image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-black mt-4">Rayyan</p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-sky-600 mt-2 text-center text-white">
        <div class="container px-6 pt-6">
            <div class="mb-6 flex justify-center">
                <a href="https://twitter.com/muattamuhariq?s=21&t=TLLrHPOl3o3dOjfKQ6qVyQ" type="button"
                ...
                <a href="https://www.instagram.com/muatta_/" type="button"
                    class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init data-te-ripple-color="light">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
                        viewBox="0 0 24 24">
                ...
                <a href="https://github.com/MuattaMuhariq/INF_2023_DY03_CleanDeKost" type="button"
                    class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init data-te-ripple-color="light">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
                        viewBox="0 0 24 24">
        ...
        <div class="p-4 text-center" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2023 Copyright:
            <a class="text-whitehite" href="https://tailwind-elements.com/">Clean De kost</a>
        </div>
    </footer>
</x-app-layout>
