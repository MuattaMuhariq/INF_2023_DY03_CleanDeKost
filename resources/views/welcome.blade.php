...
<nav class="bg-sky-600">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/"><img src="/Images/24650.png" class="h-14 mr-3" alt="Clean De Kost" /></a>
    ...
    @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 m-8   bg-sky-600">
                    @auth
                        
                    @else
                        <a href="{{ route('login') }}" class="font-semibold text-gray-900 hover:text-gray-900  dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Sign In</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-900 hover:text-gray-900  dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Sign Up</a>
                        @endif
                    @endauth
                </div>
            @endif 
...
<div id="default-carousel" class="relative w-4/5 ml-36 pt-20 drop-shadow-2xl" data-carousel="slide">
  ...
  <div class="relative  h-56 overflow-hidden rounded-lg md:h-96">
      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="{{ url('Images\Sampah1.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
      </div>
      <!-- Item 2 -->
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
  ...
  <div class="pt-20 pl-64">
    <a href="/register" class="relative w-3/4 h-56 block w-sm bg-white border border-gray-200 rounded-lg drop-shadow-2xl hover:bg-gray-100 dark:bg-white dark:border-gray-800 dark:hover:bg-gray-800">
