  ...
  <div class="overflow-hidden bg-white sm:rounded-xl relative w-5/6 ml-30 mb-60 drop-shadow-2xl container px-4 mx-auto">
    ...
    <div class="mt-6 md:flex md:items-center md:justify-between">
        <div class="inline-flex overflow-hidden bg-white border divide-x rounded-lg dark:bg-gray-900 rtl:flex-row-reverse dark:border-gray-700 dark:divide-gray-700">
            <button class="px-5 py-2 text-xs font-medium text-white transition-colors duration-200 bg-gray-100 sm:text-sm dark:bg-sky-800 dark:text-white">
                Diproses
            </button>

            <a href="/historyselesai"><button class="px-5 py-2 text-xs font-medium text-white transition-colors duration-200  sm:text-sm dark:bg-green-800 dark:text-white hover:bg-gray-100">
                Selesai
            </button></a>
        </div>
        </div>
